...
// A valid version in the given string data is one or more digits followed by a dot, 
// followed by one or more digits. So 0.6, 5.4, 14.275 and 1.99 are all valid, but versions 
// like .6, 5, 14.2.7 and 1.9.9 are invalid.
...
// If the version format is valid and the version is anything other than 2.0, replace 
// it with the version parameter supplied to your function. If it’s 2.0, don’t modify it.
